# Generated by Django 2.2.9 on 2020-01-15 02:40
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('mt_id', models.IntegerField(blank=True, null=True, verbose_name='mt_id')),
                ('sync_date', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='navmtids', to='nav_client.SyncDate', verbose_name='дата синхронизации')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('point_value', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='flattablerows', to='nav_client.Point', verbose_name='точка')),
